...
// Problem ID/title : 12356 - Army Buddies (Method 3)
//********************************************************************************
...
vector<int> soldiers_list_next;
vector<int> soldiers_list_prev;
...
int main()
{
	while(1)
	{
		...
		soldiers_list_next.resize(S+1);
		soldiers_list_prev.resize(S+1);
